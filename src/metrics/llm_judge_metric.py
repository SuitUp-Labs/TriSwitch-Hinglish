...
def _build_prompt(text_a: str, text_b: str) -> str:
    return (
        ...
        "Sentence B is provided only as a topic reference — do not compare them.\n\n"
        "Consider these dimensions and reason through each before scoring:\n"
        "  1. Word order — does the constituent order follow natural Hindi SOV or Hinglish flow?\n"
        "     (e.g. topic-fronting, verb-final, postpositional phrases in expected positions)\n"
        "  2. Code-switch placement — do Hindi/English switches occur at natural morpheme boundaries?\n"
        "  3. Prosodic naturalness — would this feel effortless to a native Hinglish speaker?\n\n"
        "After reasoning through all three, assign a CONTINUOUS score from 0.0 to 1.0.\n"
        "Rules:\n"
        "  - Do NOT round to 0.6, 0.8, or 1.0. Use fine-grained values like 0.73, 0.85, 0.91.\n"
